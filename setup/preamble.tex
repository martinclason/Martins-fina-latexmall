...
% \documentclass[11pt,a4paper]{article} % Behövde kommentera ut denna rad för att det ska fungera med nya versionen av overleaf. Denna rad ska istället stå längst upp i main.tex precis innan importen av den här filen för att dokumentet ska kompilera.
